                ...
                <>
                    ...
                    <div className='card'>
                        ...
                        <div className='col-4 text-info' >
                            ...
                            <div className="d-flex"><span className="text-muted"><b>region : </b></span> &nbsp;<p> {output.region} </p></div>
                            <div className="d-flex"><span className="text-muted"><b>capital : </b></span> &nbsp;<p> {output.capital} </p></div>
                            <div className="d-flex"><span className="text-muted"><b>Calling code : </b></span> &nbsp;<p> {output.callingCodes} </p> </div>
                            <div className="d-flex"><span className="text-muted"> <b>alpha3Code : </b></span> &nbsp;<p> {output.alpha3Code} </p></div>
                            <div className="d-flex"><span className="text-muted"><b>population : </b></span> &nbsp;<p> {output.population} </p></div>
                        </div>
                    </div>
                </>
            )}
